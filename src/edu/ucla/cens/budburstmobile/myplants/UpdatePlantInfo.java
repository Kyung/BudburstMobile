...
public class UpdatePlantInfo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		pheno_image.setImageResource(getResources().getIdentifier("edu.ucla.cens.budburstmobile:drawable/p" + pInfo.get("pIcon"), null, null));
		...
		if(file.exists()) {
			...
			photo_image.setImageResource(getResources().getIdentifier("edu.ucla.cens.budburstmobile:drawable/no_photo", null, null));
	    ...
	    photo_image.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
			    ...
			    // if not, show 'no image' ImageButton
			    	...
			    	image_view.setImageResource(getResources().getIdentifier("edu.ucla.cens.budburstmobile:drawable/no_photo", null, null));
			    }
