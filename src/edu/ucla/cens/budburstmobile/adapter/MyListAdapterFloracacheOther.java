...
import edu.ucla.cens.budburstmobile.myplants.DetailPlantInfoFloracache;
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		thumbnail.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				phenoView.setImageResource(mContext.getResources().getIdentifier("edu.ucla.cens.budburstmobile:drawable/p" + phenoIcon, null, null));
