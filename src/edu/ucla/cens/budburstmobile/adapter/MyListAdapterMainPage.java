...
public class MyListAdapterMainPage extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		if(maincon.getResources().getIdentifier("edu.ucla.cens.budburstmobile:drawable/"+arSrc.get(position).getImageURL(), null, null) == 0) {
			...
			if(existFile.exists()) {
				...
				img.setImageResource(maincon.getResources().getIdentifier("edu.ucla.cens.budburstmobile:drawable/pbb_icon_main2", null, null));
			}
		}
		else {
			img.setImageResource(maincon.getResources().getIdentifier("edu.ucla.cens.budburstmobile:drawable/"+arSrc.get(position).getImageURL(), null, null));
		}
